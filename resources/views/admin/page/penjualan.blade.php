            ...
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modal_barang" name="tambah_barang" id="tambah_barang"><i class="fas fa-plus"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
            ...
            <div class="col-md-12">
                <div class="card card-warning card-outline">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#modal_garansi" name="tambah_garansi" id="tambah_garansi"><i class="fas fa-plus"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                    ...
                    <div class="card card-outline card-success">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="total_bayar" id="total_bayar" class="form-control" value="{{$data->total_bayar}}" placeholder="Total Bayar" hidden>
                                <input type="text" name="in_bayar" id="in_bayar" class="form-control" placeholder="Total Bayar" required>
                            </div>
                            <div class="form-group">
                        ...
                        <tbody>
                            @foreach ($view_penjualan as $item)
                                <tr>
                                    ...
                                    @endswitch</td>
                                    <td>
                                        <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal_view_penjualan_{{$item->id}}"><i class="fas fa-eye"></i></a>
                                        @if ($item->status_penjualan == '2')
                                            <a href="{{route('edit_penjualan',$item->id)}}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
                                ...
                                @foreach ($view_barang as $b)
                                    @if ($b->kode_penjualan == $item->id)
                                        <tr>
                                            ...
                                            <td>Rp.{{number_format($b->harga_jual_barang * $b->qty_barang)}},-</td>
                                        </tr>
                                    @endif
                                @endforeach
                            </tbody>
                                ...
                                @foreach ($view_sparepart as $b)
                                    @if ($b->kode_penjualan == $item->id)
                                        <tr>
                                            ...
                                            <td>Rp.{{number_format($b->harga_jual * $b->qty_sparepart)}},-</td>
                                        </tr>
                                    @endif
                                @endforeach
                            </tbody>
