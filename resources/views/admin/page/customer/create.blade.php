                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('customer.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="alamat_toko" name="alamat_toko" rows="3" required>{{ old('alamat_toko') }}</textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" id="status_toko" name="status_toko" required>
                                ...
                                <option value="biasa" {{ old('status_toko') == 'biasa' ? 'selected' : '' }}>Pelanggan
                                    Biasa</option>
                                <option value="konter" {{ old('status_toko') == 'konter' ? 'selected' : '' }}>Konter
                                </option>
                                <option value="glosir" {{ old('status_toko') == 'glosir' ? 'selected' : '' }}>Glosir
                                </option>
                                <option value="super" {{ old('status_toko') == 'super' ? 'selected' : '' }}>Super
                                </option>
                            </select>
                        </div>
                        <div class="form-group">
