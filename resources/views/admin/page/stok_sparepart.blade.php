    ...
    <div class="card-body">
        <div class="tab-content">
            ...
            <div class="tab-pane " id="restok">
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{route('create_sparepart_restok')}}" class="btn btn-success"><i class="fas fa-plus"></i> Restok</a>
                        <hr>
                        <table class="table" id="TABLES_2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route('delete_sparepart_restok',$item->id_restok)}}" onsubmit="return confirm('Apakah Anda yakin ?')" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            @if ($item->status_restok != 'Success')
                                            <a href="{{route('edit_sparepart_restok',$item->id_restok)}}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
            ...
            <div class="tab-pane " id="retur">
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{route('create_sparepart_retur')}}" class="btn btn-success"><i class="fas fa-plus"></i> Tambah Retur</a>
                        <hr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{route('ubah_status_retur',$item->id_retur)}}" onsubmit="return confirm('Apa Kamu Yakin ?')" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <input type="hidden" name="status_retur" id="status_retur" value="1">
            ...
            <div class="tab-pane " id="rusak">
                <a href="{{route('create_sparepart_rusak')}}" class="btn btn-success"><i class="fas fa-plus"></i> Tambah</a>
                <hr>
                <table class="table" id="TABLES_1">
                    <thead>
                        <th>No</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{route('delete_sparepart_rusak',$item->id_rusak)}}" onsubmit="return confirm('Apakah Anda yakin ?')" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <a href="{{route('edit_sparepart_rusak',$item->id_rusak)}}" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                </form>
                            </td>
                        </tr>
                    @endforeach
