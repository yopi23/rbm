            ...
            <div class="info-box-content">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12 my-2">
                            <input type="date" value="{{isset($request->tgl_awal) ? $request->tgl_awal : ''}}" name="tgl_awal" id="tgl_awal" class="form-control" hidden>
                            <input type="date" value="{{isset($request->tgl_akhir) ? $request->tgl_akhir : ''}}" name="tgl_akhir" id="tgl_akhir" class="form-control" hidden>
                    ...
                    <div class="col text-right">
                        <strong style="font-family: 'Courier New', Courier, monospace;" class="pt-3 pb-3">@php echo date('l,d-M-Y') @endphp</strong>
                    </div>
                </div>
                </form>
            </div>
    ...
    <div class="col-12 col-sm-6 col-md-4">
      <div class="info-box mb-3">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number">Rp.{{number_format($totalPenjualan + $totalPendapatanService)}},-</span>
          @endif
        </div>
        <!-- /.info-box-content -->
      </div>
    ...
    <div class="col-12 col-sm-6 col-md-4">
      <div class="info-box mb-3">
        ...
        <div class="info-box-content">
          ...
          @if(isset($totalPendapatanService))
          <span class="info-box-number">Rp.{{number_format($totalPendapatanService - $total_part_service)}},-</span>
        @endif
        </div>
        <!-- /.info-box-content -->
      </div>
    ...
    <div class="col-12 col-sm-6 col-md-4">
      <div class="info-box mb-3">
        ...
        <div class="info-box-content">
          ...
          @if(isset($totalPendapatanService))
          <span class="info-box-number">Rp.{{number_format(($totalPendapatanService - $total_part_service)+($totalPenjualan-$totalModalJual))}},-</span>
        @endif
        </div>
        <!-- /.info-box-content -->
      </div>
                                    ...
                                    $total_part = 0;
                                        foreach($all_part_toko_service as $a){
                                            if($item->id == $a->kode_services){
                                                $total_part += (($a->detail_harga_part_service - $a->total_biaya) * $a->qty_part);
                                            }
                                        }
                                    @endphp
                                @endif
                            ...
                            <tbody>
                                @foreach ($penjualan_sparepart as $item)
                                   <tr>
                                    ...
                                    <td>Rp.{{number_format(($item->detail_harga_jual * $item->qty_sparepart) - $item->detail_harga_modal)}}</td>
                                   </tr>
                                @endforeach
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                @foreach ($sparepart_pesanan as $item)
                                   <tr>
                                    ...
                                    <td>Rp.{{number_format(($item->detail_harga_pesan * $item->qty_sparepart) - $item->harga_beli)}}</td>
                                   </tr>
                                @endforeach
                            </tbody>
                        </table>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-success">
                <div class="card-header">
                    <div class="card-title">
                        Laporan Pesanan Hanphones/ Barang Tanggal {{$request->tgl_awal }} S/d {{$request->tgl_akhir}}
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                            ...
                            <tbody>
                                @foreach ($barang_pesanan as $item)
                                   <tr>
                                    ...
                                    <td>Rp.{{number_format(($item->detail_harga_pesan * $item->qty_barang) - $item->harga_beli_barang)}}</td>
                                   </tr>
                                @endforeach
                            </tbody>
                        </table>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-success">
                <div class="card-header">
                    <div class="card-title">
                        Laporan Pengeluaran Operasional Tanggal {{$request->tgl_awal }} S/d {{$request->tgl_akhir}}
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-success">
                <div class="card-header">
                    <div class="card-title">
                        Laporan Penarikan Saldo Karyawan Tanggal {{$request->tgl_awal }} S/d {{$request->tgl_akhir}}
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
...
<script type="text/javascript">
    $(function() {
        ...
        // const end = moment();
        const start = moment($('#tgl_awal').val()||moment().startOf('day')); // Mengambil nilai tanggal awal yang sudah di-submit
    const end = moment($('#tgl_akhir').val()||moment()); // Mengambil nilai tanggal akhir yang sudah di-submit
