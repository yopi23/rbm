        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title">
                    ...
                    input Pesanan #{{ $order->kode_order }}
                </h3>
                    ...
                    <tbody>
                        @forelse($lowStockItems as $item)
                            <tr
                                ...
                                <td class="text-center">
                                    <form action="{{ route('order.add-low-stock-item', $order->id) }}" method="POST"
                                        class="d-inline add-stock-form">
                                        @csrf
