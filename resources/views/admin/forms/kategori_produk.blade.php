            ...
            <div class="col-md-12">
              @if(session('error'))
                ...
                <div class="card card-outline card-success">
                    ...
                    <form action="{{ isset($data) != null ? route('UpdateKategoriProduk',$data->id) : route('StoreKategoriProduk') }}" method="POST" enctype="multipart/form-data">
                      @csrf
                      @if (isset($data) != null)
                          @method('PUT')
                      @else
                      ...
                      <div class="card-footer">
                        ...
                        <a href="{{route('kategori_produk')}}" class="btn btn-danger">Kembali</a>
                      </div>
                    </form>
                </div>
            </div>
