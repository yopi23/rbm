            ...
            <div class="col-md-12">
              @if(session('error'))
                  ...
                  <div class="card card-outline card-success">
                    ...
                    <form action="{{ isset($data) != null ? route('owner.update',$data->id_user) : route('owner.store') }}" method="POST"enctype="multipart/form-data">
                      @csrf
                      @if (isset($data) != null)
                          @method('PUT')
                      @else
                      ...
                      <div class="card-footer">
                        ...
                        <a href="{{route('owner.index')}}" class="btn btn-danger">Kembali</a>
                      </div>
                    </form>
                </div>
            </div>
