        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <form action="{{ route('update_detail_service', $data->id) }}" method="POST"
                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="card-tools">
                                                <a href="#" class="btn btn-secondary" data-toggle="modal"
                                                    data-target="#modal_catatan" name="tambah_catatan"
                                                    id="tambah_catatan"><i class="fas fa-plus"></i> Tambah</a>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    <tbody>
                                                        @foreach ($catatan as $item)
                                                            <tr>
                                                                ...
                                                                <td>{{ $item->name }}</td>
                                                                <td>
                                                                    <form onsubmit="return confirm('Apa Kamu Yakin ?')"
                                                                        action="{{ route('delete_catatan_service', $item->id_catatan) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit"
                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="card-tools">
                                                <a href="#" data-toggle="modal"
                                                    data-target="#modal_sparepart_luar" class="btn btn-primary"
                                ...
                                <div class="col-md-12">
                                    <div class="card card-outline card-success">
                                        <div class="card-header">
                                            ...
                                            <div class="card-tools">
                                                <a href="#" class="btn btn-success" data-toggle="modal"
                                                    data-target="#modal_garansi" name="tambah_garansi"
                                                    id="tambah_catatan"><i class="fas fa-plus"></i> Tambah</a>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    <tbody>
                                                        @foreach ($garansi as $item)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <form
                                                                        action="{{ route('delete_garansi_service', $item->id) }}"
                                                                        onsubmit="return confirm('Apakah Anda yakin ?')"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <a href="#" data-toggle="modal"
                                                                            data-target="#modal_edit_garansi_{{ $item->id }}"
                                                                            class="btn btn-warning"><i
                                                                                class="fas fa-edit"></i></a>
                                                                        <button type="submit"
                                                                            class="btn btn-danger"><i
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="hidden" name="kode_services" id="kode_services"
                                    value="{{ $data->id }}">
                                <label>Tanggal</label>
                                <input type="date" value="{{ date('Y-m-d') }}" name="tgl_catatan_service"
                                    id="tgl_catatan_service" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Catatan</label>
                                <textarea name="catatan_service" placeholder="Catatan" id="catatan_service" class="form-control" cols="30"
                                    rows="10"></textarea>
                            </div>
                        </div>
                        <div class="modal-footer justify-content-between">
                    ...
                    <form action="{{ route('store_garansi_service') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <input type="hidden" name="kode_garansi" id="kode_garansi"
                                value="{{ $data->kode_service }}">
                            <div class="form-group">
                                <label>Nama Garansi</label>
                                <input type="text" placeholder="Nama Garansi" name="nama_garansi"
                                    id="nama_garansi" class="form-control" required>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                    ...
                    <div class="modal-content">
                        ...
                        <form action="{{ route('update_garansi_service', $item->id) }}" method="POST">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label>Nama Garansi</label>
                                    <input type="text" placeholder="Nama Garansi"
                                        value="{{ $item->nama_garansi }}" name="nama_garansi" id="nama_garansi"
                                        class="form-control" required>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Tanggal Mulai Garansi</label>
                                            <input type="date" name="tgl_mulai_garansi" id="tgl_mulai_garansi"
                                                value="{{ $item->tgl_mulai_garansi }}" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Tanggal Exp Garansi</label>
                                            <input type="date" name="tgl_exp_garansi" id="tgl_exp_garansi"
                                                value="{{ $item->tgl_exp_garansi }}" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Catatan Garansi</label>
                                    <textarea name="catatan_garansi" placeholder="Catatan Garansi ..." id="catatan_garansi" class="form-control"
                                        cols="30" rows="3">{{ $item->catatan_garansi }}</textarea>
                                </div>
                            </div>
                            <div class="modal-footer justify-content-between">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
