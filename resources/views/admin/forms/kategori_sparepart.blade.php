            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-outline card-success">
                        ...
                        <form
                            action="{{ isset($data) != null ? route('UpdateKategoriSparepart', $data->id) : route('StoreKategoriSparepart') }}"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    @if (isset($data) && $data->foto_kategori != '-')
                                        <img src="{{ asset('public/uploads/' . $data->foto_kategori) }}" width="25%"
                                            height="25%" class="img" id="view-img">
                                    @else
                                        <img src="{{ asset('public/img/no_image.png') }}" width="25%" height="25%"
                                            class="img" id="view-img">
                                    @endif
                                    <br>
                                    <label>Foto Kategori</label>
                                    <input type="file" accept="image/jpeg, image/png" class="form-control"
                                        name="foto_kategori" id="foto_kategori">
                                </div>
                                <div class="form-group">
