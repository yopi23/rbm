<form action="{{ route('create_pemasukkan_lain') }}" method="POST">
    @csrf
    @method('POST')
    <div class="formpemasukan d-none">
        ...
        <div class="input-group my-2">
            ...
            <input type="text" name="judul_pemasukan" id="judul_pemasukan_lain" placeholder="judul"
                class="form-control" required>
            <input type="date" name="tgl_pemasukan" id="tgl_pemasukan_lain" class="form-control"
