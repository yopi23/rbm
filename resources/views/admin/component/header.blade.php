...
<head>
  ...
  <link rel="shortcut icon" href="{{asset('public/')}}/img/yoygreen.png" type="image/x-icon">
...
<div class="wrapper">
  ...
  {{-- <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset('public/')}}/img/yoygreen.png" alt="AdminLTELogo" height="60" width="60">
  </div> --}}