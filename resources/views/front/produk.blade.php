                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <input type="text" name="ref"
                            @if (isset($request) != null) value="{{ $request->ref }}" @endif placeholder="Kode Invite ?"
                            ...
                            <div class="col-md-3">
                                <div class="card card-outline">
                                    <div class="text-center">
                                        @if ($item->foto_barang != '-')
                                            <img src="{{ asset('public/uploads/' . $item->foto_barang) }}" width="100%"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <small
                                                class="border p-1">{{ $item->stok_barang > 0 ? 'Tersedia' : 'Kosong' }}</small>
                                            @if ($ismember)
                                                <form action="{{ route('add_produk_cart', $item->id_produk) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
