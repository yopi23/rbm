    ...
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      ...
      <form action="{{route('spareparts')}}"  method="GET">
        ...
        <br>
          ...
          <div class="col-md-3">
            <input type="text" @if (isset($request->ref) != null)
            value="{{$request->ref}}"
        @endif name="ref" placeholder="Kode Invite ?" id="ref" class="form-control">
        <br>
          </div>
          <div class="col-md-1">
                ...
                <div class="col-md-3">
                  <div class="card card-outline">
                          <div class="text-center">
                            ...
                            <img src="{{asset('public/uploads/'.$item->foto_sparepart)}}" width="100%" height="100%" class="card-img-top img-fluid img-thumbnail" id="view-img">
                            @else
                      ...
                      <div class="card-body">
                            ...
                            @if ($ismember)
                            <h5 class="">Rp.{{number_format($item->harga_jual)}},-</h5>
                            @endif
                            <div class="d-flex justify-content-between">
                              <small class="border p-1">{{$item->stok_sparepart > 0 ? 'Tersedia' : 'Kosong'}}</small>
                              @if ($ismember)
                              <form action="{{route('add_sparepart_cart',$item->id_produk)}}" method="POST">
                                @csrf
                                @method('PUT')
