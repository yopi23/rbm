    ...
    <table style="width: 100%;" >
        <tbody>
            ...
            <tr class="text-center" style="font-size: 14px">
                <td colspan="3" >YOYOY CELL<p style="margin-bottom: 0;">085603124871 (CS) <br> www.yoyoycell.com</p></td>
            </tr>
            <tr>
                <td colspan="3">===================</td>
            </tr>
    ...
    <table class="my-2" style="width: 100%; font-size:8pt">
        <tbody>
            <tr class="border border-dark text-center">
                <td><p style="margin-bottom: 0;">3 Bulan tidak diambil<br> berarti anda sudah memberikannya kepada kami</p></td>
            </tr>
        </tbody>
    </table>
