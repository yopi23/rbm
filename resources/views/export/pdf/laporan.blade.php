...
<body>
    ...
    <center>
        <h6>Laba Sparepart (Terpakai Untuk Service)</h6>
    </center>
    <table class="table table-bordered" style="width: 100%">
        <thead>
            <tr>
    ...
    <center>
        <h6>Sparepart Luar Toko(Terpakai Untuk Service)</h6>
    </center>
    <table class="table table-bordered" style="width: 100%">
        <thead>
            <tr>
    ...
    <center>
        <h6>Laba Penjualan Sparepart</h6>
    </center>
    <table class='table table-bordered' style="width: 100%;">
        <thead>
            <tr>
    ...
    <center>
        <h6>Laba Penjualan Handphone / Barang</h6>
    </center>
    <table class='table table-bordered' style="width: 100%;">
        <thead>
            <tr>
    ...
    <center>
        <h6>Laba Pesanan Handphone / Barang</h6>
    </center>
    <table class='table table-bordered' style="width: 100%;">
        <thead>
            <tr>
    ...
    <center>
        <h6>Pengeluaran Operasional (OPEX)</h6>
    </center>
    <table class='table table-bordered' style="width: 100%;">
        <thead>
            <tr>
    ...
    <center>
        <h6>Penarikan Saldo Karyawan</h6>
    </center>
    <table class='table table-bordered' style="width: 100%;">
        <thead>
            <tr>
