...
<html>
<head>
	<title>Laporan ALL IN ONE {{$owner->fullname}}</title>
...
<body>
    ...
    <table style="width: 100%; border:0;">
        <tbody>
            ...
            <tr>
                <td>Owner : {{$owner->fullname}} ( {{$owner->kode_invite}} ) </td>
    ...
    <table class="table table-bordered" style="width: 100%">
        ...
        <tbody>
            ...
            @php
                $harga_part_service = ($item->detail_harga_part_service) * $item->qty_part;
